...
export const FALLBACK_FORM_PROVIDERS: FormProvider[] = [
  ...
  { slug: "databricks", label: "Databricks", enumValue: "DATABRICKS", logoUrl: "/logos/databricks.svg", brandColor: "#FF3621" },
...
export const FALLBACK_HOME_PROVIDERS: HomeProvider[] = [
  ...
  { slug: "databricks", name: "Databricks", short: "Databricks", count: 8, blurb: "Lakehouse & Data Engineering", logo: "/logos/databricks.svg" },
...
export const FALLBACK_PROVIDER_LOGOS: Record<string, ProviderLogo> = {
  ...
  databricks: { logo: "/logos/databricks.svg" },
