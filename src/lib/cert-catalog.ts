...
export const FALLBACK_FORM_PROVIDERS: FormProvider[] = [
  ...
  { slug: "anthropic", label: "Anthropic", enumValue: "ANTHROPIC", logoUrl: "/logos/anthropic.svg", logoLightUrl: "/logos/anthropic.svg", brandColor: "#D97757" },
...
export const FALLBACK_PROVIDER_LOGOS: Record<string, ProviderLogo> = {
  ...
  anthropic: { logo: "/logos/anthropic.svg", light: "/logos/anthropic.svg" },
