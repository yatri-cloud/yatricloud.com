...
export function GlobalSearch() {
    ...
    return (
        <>
            {/* Icon-only trigger so the header nav keeps its full width; the
                accessible name comes from the sr-only content (no visible
                text, so no label-content-name-mismatch). */}
            <button
                type="button"
