                                ...
                                <div className="flex items-center justify-between gap-3">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <Button
                                            variant="outline"
                                            size="icon"
                                            onClick={async () => { if (await confirm("Are you sure? This cannot be undone.")) { deleteRow(index); } }}
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <Button
                                                variant="outline"
                                                size="icon"
                                                onClick={async () => { if (await confirm("Are you sure? This cannot be undone.")) { deleteFaq(index); } }}
