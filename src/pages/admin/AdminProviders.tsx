...
const KNOWN_LOGO_KEYS = ["aws", "azure", "gcp", "databricks", "redis", "anthropic", "snowflake", "kubernetes", "terraform", "hashicorp", "docker", "github", "salesforce", "oracle", "servicenow", "openai", "cisco", "comptia", "linux", "nvidia", "ibm", "alibaba"];
