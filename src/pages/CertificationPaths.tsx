...
const GOALS: Goal[] = [
    ...
    },
    {
        id: "data-ai",
        label: "Data & AI",
        tagline: "Turn data into decisions with analytics, ML, Databricks, Snowflake and AI certifications.",
        providers: ["aws", "azure", "gcp", "databricks", "snowflake", "oracle", "openai", "anthropic"],
        topic: /(data|ai|machine learning|analytics|databricks|lakehouse|snowflake|database|claude|prompt)/i,
        stages: LEVEL_STAGES,
    },
    {
        id: "security",
