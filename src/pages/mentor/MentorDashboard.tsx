                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <Button
                        ...
                        onClick={async () => { if (await confirm("Are you sure? This cannot be undone.")) { setToDelete(s); } }}
                      >
                        Delete
                      </Button>
                    </div>
              ...
              <div className="grid gap-3">
                ...
                {form.questions.map((question, index) => (
                  <div key={index} className="flex items-center gap-2">
                    ...
                    <Button variant="ghost" size="sm" onClick={async () => { if (await confirm("Are you sure? This cannot be undone.")) { removeQuestion(index); } }}>
                      Remove
                    </Button>
                  </div>
                ))}
              ...
              {rules.map((rule) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button variant="ghost" size="sm" onClick={async () => { if (await confirm("Are you sure? This cannot be undone.")) { removeRule(rule); } }}>
                      Remove
                    </Button>
                  </div>
                </div>
            ...
            <div className="flex flex-col gap-3">
              {upcomingOverrides.map((o) => (
                ...
                >
                  ...
                  <Button variant="ghost" size="sm" onClick={async () => { if (await confirm("Are you sure? This cannot be undone.")) { removeOverride(o); } }}>
                    Remove
                  </Button>
                </div>
              ))}
                      ...
                      <div className="flex flex-wrap items-center justify-end gap-2 min-w-[320px]">
                        ...
                        {(b.status === "confirmed" || b.status === "pending") && (
                          <Button
                            ...
                            className="text-destructive hover:bg-destructive hover:text-destructive-foreground"
                            disabled={busyId === b.id}
                            onClick={async () => { if (await confirm("Are you sure? This cannot be undone.")) { setCancelTarget(b); } }}
                          >
                            Cancel
                          </Button>
                        )}
