// Salesforce Certifications Google Apps Script
// This script handles form submissions and data retrieval for Salesforce certifications only

// Configuration
const SPREADSHEET_ID = 'YOUR_SALESFORCE_SHEET_ID'; // Replace with your Salesforce Google Sheet ID
const MAIN_SHEET_NAME = 'certified-salesforce-yatris';
