// Azure Certifications Google Apps Script
// This script handles form submissions and data retrieval for Azure certifications only

// Configuration
const SPREADSHEET_ID = '1WjcJIZ5FMPr8ufy6Ij4QUHBogItlE45R2WtMOh4H2Ow'; // Azure Google Sheet ID
const MAIN_SHEET_NAME = 'certified-azure-yatris';
...
function doGet(e) {
  try {
    ...
    for (let sheet of sheets) {
      ...
      // Skip main sheet (it starts with "certified-")
