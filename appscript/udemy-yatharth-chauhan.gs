// Udemy Courses - Yatharth Chauhan Google Apps Script
// This script handles form submissions and data retrieval for Yatharth Chauhan's Udemy courses

// Configuration
const SPREADSHEET_ID = '1nQFIH00eNhTqUWmZ7ixq8GFP59Kh-cvEmY-eNA5Kxtw'; // Yatharth Chauhan Google Sheet ID
const MAIN_SHEET_NAME = 'udemy-yatharth-chauhan';
