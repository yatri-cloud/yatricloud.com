// GCP Certifications Google Apps Script
// This script handles form submissions and data retrieval for GCP certifications only

// Configuration
const SPREADSHEET_ID = 'YOUR_GCP_SHEET_ID'; // Replace with your GCP Google Sheet ID
const MAIN_SHEET_NAME = 'certified-gcp-yatris';
