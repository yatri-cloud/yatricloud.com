// GitHub Certifications Google Apps Script
// This script handles form submissions and data retrieval for GitHub certifications only

// Configuration
const SPREADSHEET_ID = 'YOUR_GITHUB_SHEET_ID'; // Replace with your GitHub Google Sheet ID
const MAIN_SHEET_NAME = 'certified-github-yatris';
