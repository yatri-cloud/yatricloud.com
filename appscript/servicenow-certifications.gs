// ServiceNow Certifications Google Apps Script
// This script handles form submissions and data retrieval for ServiceNow certifications only

// Configuration
const SPREADSHEET_ID = 'YOUR_SERVICENOW_SHEET_ID'; // Replace with your ServiceNow Google Sheet ID
const MAIN_SHEET_NAME = 'certified-servicenow-yatris';
