// HashiCorp Certifications Google Apps Script
// Sheet: https://docs.google.com/spreadsheets/d/1kErXodwrFgSgswBka3XHs_58P6aAxsZqyGo8SOnfa6k/edit?gid=0
// Main sheet name: certified-hashicorp-yatris
//
// Supports Terraform, Vault, Consul, etc. The frontend sends generic
// certificationName / examCode so this script is provider-agnostic.

// Configuration
const SPREADSHEET_ID = '1t8rnW879mABI8_w2fseqvZqXuXIRj-8INIZWJ2Lece8';
const MAIN_SHEET_NAME = 'certified-hashicorp-yatris';
